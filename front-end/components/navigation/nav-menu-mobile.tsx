...
const titleItemCls = "select-none rounded-md leading-none no-underline outline-hidden text-2xl";
        ...
        <nav className="flex sm:hidden p-4 flex-row">
            ...
            <div className="flex flex-row grow justify-end text-lg">
                <button data-collapse-toggle="navbar-default" type="button" onClick={handleMenuClick}
                        className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-hidden focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
