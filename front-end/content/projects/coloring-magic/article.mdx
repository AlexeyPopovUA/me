...
draft: false
featured: true
description: A full-stack product for generating custom printable coloring book PDFs with AI. Users describe a book in plain English, review prompts, and download a print-ready A4 or square PDF—plus a marketing site with weekly sample downloads and an MDX blog.
