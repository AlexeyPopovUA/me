...
draft: false
featured: true
description: Personal blog, portfolio, and resume built with statically exported Next.js, MDX content, AWS CDK, and a self-hosted AWS Serverless Image Handler image service.
