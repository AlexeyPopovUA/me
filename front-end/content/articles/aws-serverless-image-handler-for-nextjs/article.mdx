...
## I've built a demo app

It shows different implementation of images in a static Next.js app and AWS Serverless Image Handler.

![/articles/nextjs-images/home-page.png](/articles/nextjs-images/home-page.png "Home page")

### Single responsive image

Loading different image sizing during the page load (normal network):
...
Loading process of a single responsive image (3G network emulation):
