...
<video width="100%" style={{aspectRatio: 1.736}} controls preload="none" autoplay loop muted>
  <source src="/content/articles/aws-serverless-image-handler-for-nextjs/full-image-thumbnails-loading-animation.webm" type="video/webm" />
  Your browser does not support the video tag.
</video>

![/articles/nextjs-images/home-page.png](/articles/nextjs-images/home-page.png)
