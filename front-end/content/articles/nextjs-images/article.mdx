...
lastMod: 2025-06-10
draft: false
description: Guide to optimizing Next.js static site images with AWS Serverless Image Handler—remote optimization, setup steps, and practical trade-offs for developers.
...
![Next.js image optimization architecture with AWS Serverless Image Handler](/articles/nextjs-images/article-hero.png)
...
![Original AWS Serverless Image Handler architecture diagram](/articles/nextjs-images/serverless-image-handler-original.png "Original architecture (© AWS Solutions)")

There is also an optional demo app that lets you try out the Serverless Image Handler service with a sample image:

![Serverless Image Handler demo application screenshot](/articles/nextjs-images/image-handler-demo.png "Image handler demo app")
...
![Next.js remote images demo landing page screenshot](/articles/nextjs-images/landing-page.png "Home page")
