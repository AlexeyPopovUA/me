...
"pnpm": { "overrides": { "lodash": "4.17.21" } }  // pnpm

// Target specific dependency paths
"overrides": { "package-a": { "lodash": "3.10.1" } }  // npm
"resolutions": { "package-a/lodash": "3.10.1" }       // Yarn  
"pnpm": { "overrides": { "package-a>lodash": "3.10.1" } }  // pnpm
```
...
**Tool Configuration:**
```json
// TypeScript module resolution for PnP
{
  "compilerOptions": {
