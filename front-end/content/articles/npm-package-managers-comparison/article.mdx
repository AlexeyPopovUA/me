...
[^1]: State of Frontend 2024 Report - The Software House. Survey of 3,000+ developers on tool preferences and trends.

[^2]: Based on npm download statistics and GitHub activity trends analysis from npm trends and State of JS 2024 survey data.

[^3]: pnpm.io official benchmarks (2025). Tests performed on a medium-sized project with 1,000 dependencies on GitHub Actions runners. Available at: https://pnpm.io/benchmarks

[^4]: Disk space measurements from real-world monorepo projects. Savings depend on dependency overlap between projects. Source: pnpm documentation on symlinks and hard links.
