...
lastMod: 2025-06-10
draft: false
description: Deliver runtime configuration to web apps without rebuilding—decouple build and runtime environments with a dedicated AWS-backed configuration service.
...
![All development environments configuration demo](/articles/environment-configuration/default.png "https://feature-123.dev.config-demo.examples.oleksiipopov.com/index.html, https://main.dev.config-demo.examples.oleksiipopov.com/index.html")
...
![Acceptance environment configuration demo screenshot](/articles/environment-configuration/acc.png "https://acc.config-demo.examples.oleksiipopov.com/index.html")

**Production** environment `prod.config-demo.examples.oleksiipopov.com`:

![Production environment configuration demo screenshot](/articles/environment-configuration/prod.png "https://prod.config-demo.examples.oleksiipopov.com/index.html")

**Any random** environment, which is not supported by our configuration service should fail with CORS error:

![Random environment configuration demo screenshot](/articles/environment-configuration/random.png "https://random.config-demo.examples.oleksiipopov.com/index.html")
