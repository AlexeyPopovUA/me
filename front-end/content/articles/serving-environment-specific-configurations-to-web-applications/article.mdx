...
https://feature-123.dev.config-demo.examples.oleksiipopov.com/index.html
https://main.dev.config-demo.examples.oleksiipopov.com/index.html
...
A special Dev special.dev.config-demo.examples.oleksiipopov.com environment that has it’s own configuration:
...
Lets see how the actual configuration objects look like. I’ve implemented the hierarchy exactly the way it is described on the diagram “Example of serving environment-specific configuration”. Inheritance is implemented via merging configurations based on "environment" and "extends" keys.
