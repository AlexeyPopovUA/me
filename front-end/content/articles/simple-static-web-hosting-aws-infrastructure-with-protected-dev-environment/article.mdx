...
lastMod: 2026-06-08
draft: false
description: Step-by-step AWS static hosting setup with public prod and protected dev environments—CloudFront, S3, WAF, Route53, and GitHub Actions for branch deployments.
